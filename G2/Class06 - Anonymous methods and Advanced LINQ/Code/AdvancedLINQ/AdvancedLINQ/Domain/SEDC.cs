...
namespace AdvancedLINQ.Domain
{
    public static class SEDC
    {
        ...
        {
            new Subject(15, "C# Basic", 10, 24, AcademyType.WebProgramming ),
            new Subject(16,"C# Advanced", 15, 26, AcademyType.WebProgramming ),
            new Subject(44, "JavaScript", 25, 22, AcademyType.WebProgramming ),
